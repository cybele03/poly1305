...
void
poly1305::poly1305_init(poly1305_context *ctx, const unsigned char key[32]) {
...
/// @param c
static void
poly1305::poly1305_add(unsigned char h[17], const unsigned char c[17]) {
	unsigned short u;
	unsigned int i;
	for (u = 0, i = 0; i < 17; i++) {
...
/// @param hr
static void
poly1305::poly1305_squeeze(unsigned char h[17], unsigned long hr[17]) {
	unsigned long u;
	unsigned int i;
	u = 0;
	for (i = 0; i < 16; i++) {
...
/// @param h
static void
poly1305::poly1305_freeze(unsigned char h[17]) {
...
static void
poly1305::poly1305_blocks(poly1305_state_internal_t *st, const unsigned char *m, size_t bytes) {
...
poly1305::poly1305_finish(poly1305_context *ctx, unsigned char mac[16]) {
	poly1305_state_internal_t *st = (poly1305_state_internal_t *)ctx;
	size_t i;
